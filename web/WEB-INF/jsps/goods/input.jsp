...
//			$.post("goodsTypeAction_getAll.action",{"gtm.supplier.uuid":$(this).val()},function(data){
//				$("#goodsType").empty();
...
//		});
		$("#supplier").change(function() {
			$.post("goodsType_ajaxGetBySupplier.action",{"gtm.sm.uuid":$(this).val()},function (data) {
				$("#goodsType").empty();
			...
			<s:form action="goods_save" method="post">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
						  <s:select id="supplier" list="supplierList" name="gm.gtm.sm.uuid" listKey="uuid" listValue="name" cssStyle="width:190px"/>
				      </td>
				      <td width="18%"align="center">商品类别</td>
				      <td width="32%">
						  <s:select id="goodsType" list="goodsTypeList" name="gm.gtm.uuid" listKey="uuid" listValue="name" cssStyle="width:190px"/>
					  </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
