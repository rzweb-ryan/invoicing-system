...
<script type="text/javascript">
	...
	function showMsg(msg,uuid){
		...
		top.$('hid-action').value="goods_delete.action?gtm.uuid="+uuid;
		top.lock.show();
	}
</script>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>供应商:</td>
						<td>
							<s:select list="supplierList" name="gqm.gtm.sm.uuid" listKey="uuid" listValue="name" headerKey="-1"
							headerValue="---请-选-择---"/>
						</td>
						<td height="30">商&nbsp;品&nbsp;名</td>
						<td><input type="text" size="14" /></td>
						<td>生产厂家</td>
						<td><input type="text" name="gqm.producer" size="14" /></td>
						<td>单&nbsp;&nbsp;&nbsp;&nbsp;位</td>
						<td><input type="text" name="gqm.unit" size="14" /></td>
						...
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								...
								<span style="line-height:12px; text-align:center;"> 
									<a href="goods_input.action?gm.uuid=${uuid}" class="xiu">修改</a>
								</span>
