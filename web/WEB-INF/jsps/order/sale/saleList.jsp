...
<div class="content-right">
	<div class="content-r-pic_w">
		<div style="margin:8px auto auto 12px;margin-top:6px">
			<span class="page_title">出货订单管理</span>
		</div>
	</div>
	<div class="content-text">
		<s:form action="order_saleList.action" method="post">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>
							<s:select list="@invoice.order.vo.OrderModel@saleStatusMap" name="oqm.status"
			...
			<div class="square-order">
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr align="center" bgcolor="#FFFFFF">
						...
						<td>
							<a href="order_saleDetail.action?om.uuid=${uuid}" class="xiu">详情</a>
						</td>
						<td>${statusView}</td>
					</tr>
					</s:iterator>
