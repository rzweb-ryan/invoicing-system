...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<s:form action="storage_save.action" method="post">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
						...
						<td width="18%" height="30" align="center">是否已满</td>
				      <td width="32%">
						  <s:select name="sm.isFull" list="@invoice.storage.vo.StorageModel@isFullMap" cssStyle="width:190px"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
