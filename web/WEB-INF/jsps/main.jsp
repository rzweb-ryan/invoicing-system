...
<title>NYC-xx Invoicing System-Main Page</title>
...
<body>
	<div class="container">
		<div class="head">
			<div class="head-left">
				<span style="font-weight:bold; color:#1f4906">Welcome-</span><br />
				<span style="color:#4a940d">${session.loginEmp.username}</span>
			</div>
			<div class="head-right">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="32%">
							<a href="emp_toChangePwd.action?em.uuid=${loginEmp.uuid}" target="main">
		...
		<div class="content">
			...
			<iframe id="frame-contect" src="context.action"
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="82%"><img src="images/icon_1.gif" />&nbsp; <a
							class="lanyo" href="http://my.rzweb.us">Ryan Zhang-rzweb.us@gmail.com</a></td>
						<td width="18%" valign="middle"><img src="images/icon_2.gif" />&nbsp;
							<a class="lanyo" href="http://my.rzweb.us">Plz feel free to email me</a></td>
					</tr>
				</table>
			</div>
