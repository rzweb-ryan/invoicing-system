				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
						   <s:select list="supplierList" name="gtm.sm.uuid" listKey="uuid" listValue="name" headerKey="-1" headerValue="----请-选-择----" cssClass="kuan" cssStyle="width:190px"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
						  <s:textfield name="gtm.name" size="25"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
