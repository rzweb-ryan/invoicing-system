...
<script type="text/javascript">
	$(function() {
		$("#all").click(function() {
			$("[name=rmUuids]:checkbox").attr("checked",$("#all").attr("checked")=="checked");
		});
		$("#reverse").click(function() {
			$("[name=rmUuids]:checkbox").each(function () {
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
						  <s:textfield size="25" name="mm.name"/>
				      </td>
				      <td width="18%" align="center">所属父菜单</td>
				      <td width="32%">
						  <s:select list="parentList" name="mm.parent.uuid" listKey="uuid" listValue="name" cssStyle="width:190px"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
						  <s:textfield size="82" name="mm.url"/>
					  </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
						  <s:checkboxlist list="roleList" name="rmUuids" listKey="uuid" listValue="name"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
