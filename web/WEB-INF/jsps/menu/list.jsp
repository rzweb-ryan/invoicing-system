			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="123">&nbsp;</td>
						<td width="62">菜单名称</td>
						<td width="142"><input type="mqm.name" size="18" /></td>
						<td width="60">所属菜单</td>
						<td width="149">
							<s:select list="menu1" name="mqm.parent.uuid" listKey="uuid" listValue="name" cssStyle="kuan"
					...
					<tr align="center" bgcolor="#FFFFFF">
						...
						<td>
							...
							<span style="line-height:12px; text-align:center;"> 
								<a href="menu_input.action?mm.uuid=${uuid}" class="xiu">修改</a>
							</span> 
