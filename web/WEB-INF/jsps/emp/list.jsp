		...
		<s:form action="emp_list" method="post">
			<div class="square-o-top">
				...
				<tr>
					...
					<td>电&nbsp;&nbsp;&nbsp;&nbsp;话</td>
					<td><s:textfield name="eqm.tel" size="14"/></td>
					<td>性&nbsp;&nbsp;&nbsp;&nbsp;别</td>
					<td>
						<s:select cssClass="kuan" name="eqm.gender" list="@auth.emp.vo.EmpModel@genderMap" headerValue="----请-选-择----" headerKey="-1"></s:select>
					</td>
				...
				<tr>
					...
					<td>部门名称</td>
					<td>
						<s:select cssClass="kuan" name="eqm.dm.uuid" list="deptList" listKaaaey="uuid" listValue="name" headerValue="----请-选-择----" headerKey="-1"/>
					...
					<s:iterator value="empList">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<span style="line-height:12px; text-align:center;">
								<a href="emp_input.action?em.uuid=${uuid}" class="xiu">修改</a>
							</span>
